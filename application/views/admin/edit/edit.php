      ...
      <div class="col-md-6">
        <div class="panel panel-flat">
          <div class="panel-body">
            <center>
              <img src="img/Logo-LSP.png" alt="<?php echo $user->nama_lengkap; ?>" class="img-circle" width="100">
            </center>
            <br>
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <label class="control-label col-lg-3">HRD</label>
                                      <div class="col-lg-9">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label class="control-label col-lg-3">NIP HRD</label>
                                        <div class="col-lg-9">
