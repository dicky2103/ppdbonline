      ...
      <div class="panel panel-flat bg-info">
        <div class="panel-heading">
          <h3 class="panel-title">
            <center>REKAPITULASI PPDB <?php echo $id['nama_lengkap']; ?> TAHUN ANGKATAN <?php echo $id['th_pelajaran']; ?> </center>
          </h3>
        </div>
      </div>
      <!-- /basic datatable -->
            ...
            <div class="col-lg-4">
              ...
              <div class="panel bg-primary-600">
                <div class="panel-body">
                  ...
                  Calon Peserta yang mendaftar Tahun <?php echo $thn_ini; ?>
                </div>
              </div>
              <!-- /current server load -->
            </div>
            ...
            <div class="col-lg-4">
              ...
              <div class="panel bg-green-400">
                <div class="panel-body">
                  ...
                  Calon Peserta yang Lulus PPDB Tahun <?php echo $thn_ini; ?>
                </div>
              </div>
              <!-- /current server load -->
            </div>
            ...
            <div class="col-lg-4">
              ...
              <div class="panel bg-danger">
                <div class="panel-body">
                  ...
                  Calon Peserta yang Tidak Lulus PPDB Tahun <?php echo $thn_ini; ?>
                </div>
              </div>
              <!-- /current server load -->
            </div>
