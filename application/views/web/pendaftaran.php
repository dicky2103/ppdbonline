                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="style">
                    <div class="wizard-div current wizard-sea" id="register">
                      <form method="post" class="wizard wizard-validation" data-style="sky" role="form" action="" enctype="multipart/form-data">
                        <fieldset>
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                              <span class="text-primary" style="font-size:16px;color:#222;">Apakah Anda setuju dengan ketentuan Pendaftaran  diatas?</span>
                              <div class="form-group" style="padding-bottom:30px;">
                                <div class="radio bg-primary" style="padding-top:10px;padding-bottom:10px;border-radius:3px;color:#222;">
                                  <label>
                                    <input type="radio" value="cek" name="cek" data-parsley-group="block0" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="condition-ck"]' required> <b>Ya, saya menyetujui ketentuan Pendaftaran !</b>
                                  </label>
                            ...
                            <div class="col-md-12">
                              <div class="panel">
                                <div class="panel-heading" style="background: #6777EF; color: honeydew;">
                                  <h2 align="center" style="margin-top: 10px;">KONFIRMASI<br><b>DATA CALON ASESI</b> </h2>
                                </div>
                                <div class="panel-body">
                                  <span style="font-size:15px">
                                    <p align="center">Proses pendaftaran  <?php echo $user['nama_lengkap']; ?> hampir selesai. <br>Silakan periksa kembali data-data yang sudah anda masukkan.</p><br><br>
                                    <div class="col-md-12">
                                      <span class="text-primary" style="font-size:18px;"><strong>Apakah data calon asesi sudah sesuai?</strong></span>
            ...
            <div class="footer">
              <div class="copyright">
                ...
                <p class="pull-right sm-pull-reset">
                  <span><a href="" class="m-r-10"><i class="fa fa-home"></i> Beranda </a> | <a href="#" class="m-l-10 m-r-10" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-legal"></i> Ketentuan & Syarat Pendaftaran</a></span>
                </p>
              </div>
            </div>
          </div>
