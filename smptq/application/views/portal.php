...
<body>
	...
	<!-- Home -->
<body style="background-image:url(asset/images/icon/th.jpeg);background-size:cover;">
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-md-12">
					...
					<p class="lead mb-5 colr"><h1><strong>Assabiqun</strong></h1></p>
				</div>	
