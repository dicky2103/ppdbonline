...
$("#modal-2").fireModal({
  title: 'PSPO PENUS Ver 1.0.0',
  body: '<h6>Asesor</h6><ul><li>Dashboard Asesor ( summary data asesi sesuai jurusan asesor/user online )</li><li>Verifikasi Data Asesi ( sesuai jurusan asesor )</li><li>Kelulusan( cek dokumen asesi, Cek Form APL 02, set pengumuman lulus/tidak )( sesuai jurusan asesor )</li><li>Kirim Pesan ( ke asesi sesuai jurusan asesor)</li><li>Data Asesi ( sesuai jurusan asesor )</li><li>Data Pesan ( pesan yang dilakukan asesor tersebut )</li></ul>'
});
